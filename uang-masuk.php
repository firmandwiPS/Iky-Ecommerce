...
if (isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO data_uang_masuk (tanggal, keterangan, jumlah) 
              VALUES ('$tanggal', '$keterangan', '$jumlah')";

    if (mysqli_query($db, $query)) {
        $_SESSION['success'] = 'Data uang masuk berhasil ditambahkan';
        echo "<script>
            Swal.fire({
                icon: 'success',
                title: 'Berhasil',
                ...
                window.location.href = 'uang-masuk.php';
            });
        </script>";
    } else {
...
if (isset($_POST['edit'])) {
    ...
    $query = "UPDATE data_uang_masuk SET 
              tanggal = '$tanggal',
...
if (isset($_GET['hapus'])) {
    ...
    $query = "DELETE FROM data_uang_masuk WHERE id = '$id'";
...
// Query data
$query = mysqli_query($db, "SELECT * FROM data_uang_masuk ORDER BY tanggal DESC");
$total_result = mysqli_fetch_assoc(mysqli_query($db, "SELECT SUM(jumlah) as total FROM data_uang_masuk"));
$total_masuk = $total_result['total'] ?? 0;
?>

<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <h1 class="m-0">Data Uang Masuk</h1>
        </div>
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="alert alert-info">
                Total Uang Masuk: <strong>Rp <?= number_format($total_masuk, 0, ',', '.'); ?></strong>
            </div>

            <div class="card">
                <div class="card-header bg-success text-white">
                    <h3 class="card-title">Daftar Uang Masuk</h3>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <!-- Delete Button -->
                                            <a href="uang-masuk.php?hapus=<?= $row['id']; ?>" 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header bg-info text-white">
                                                <h5 class="modal-title">Detail Uang Masuk</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-success">Rp <?= number_format($row['jumlah'], 0, ',', '.'); ?></p>
                                                </div>
                                                <div class="mb-3">
                                        ...
                                        <div class="modal-content">
                                            <form method="post">
                                                ...
                                                <div class="modal-header bg-warning text-white">
                                                    <h5 class="modal-title">Edit Uang Masuk</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="mb-3">
